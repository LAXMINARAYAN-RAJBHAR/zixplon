  ...
  useEffect(() => {
    ...
    supabase
      ...
      .then(({ data }) => {
        if (!data) return;
        const map = {};
        data.forEach((r) => { map[r.playlist_id] = true; });
        setAddedMap(map);
      });
  ...
  const toggleVideoInPlaylist = async (e, playlistId) => {
    ...
    if (inList) {
      await supabase
        ...
        .eq("video_id", pendingVideoId);
      setAddedMap((prev) => { const n = { ...prev }; delete n[playlistId]; return n; });
    } else {
      await supabase
        .from("playlist_items")
      ...
      <Shell>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "24px" }}>
          <button
            ...
            style={{
              ...
              color: C.primary, borderRadius: "20px", padding: "8px 16px",
          ...
          <div>
            <h1 style={{ margin: 0, color: C.text, fontSize: "20px", fontWeight: "800", fontFamily: "'Nunito', sans-serif" }}>
              {selected.playlist.title}
            </h1>
            <p style={{ margin: 0, color: C.text3, fontSize: "13px", fontWeight: "600" }}>
              {selected.items.length} video{selected.items.length !== 1 ? "s" : ""}
            </p>
          </div>
        </div>
        ...
        {selected.items.length === 0 && (
          <div style={{ textAlign: "center", padding: "60px 0", color: C.text3 }}>
            ...
            <p style={{ marginTop: "12px", fontWeight: "600", fontSize: "15px" }}>
          ...
          {selected.items.map((item, idx) => (
            ...
            >
              <span style={{
                ...
                color: C.text3, fontWeight: "800", fontSize: "13px",
              ...
              >
                <div style={{
                  ...
                  <img
                    src={item.video.thumbnail_url || "https://via.placeholder.com/120x68?text=No+Thumb"}
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <p style={{
                    margin: "0 0 4px", color: C.text, fontWeight: "700",
                  ...
                  <p style={{ margin: 0, color: C.primary2, fontSize: "12px", fontWeight: "700" }}>
  ...
  return (
    <Shell>
      ...
      <div style={{
        ...
        <div style={{ flex: 1 }}>
          <h1 style={{
            margin: 0, color: C.text, fontSize: "22px", fontWeight: "800",
            fontFamily: "'Nunito', sans-serif",
          }}>
            Playlists
          </h1>
      ...
      {creating && (
        <div style={{
          ...
          <input
            ...
            style={{
              flex: 1, border: `1.5px solid ${C.border}`, borderRadius: "10px",
          ...
          <button
            ...
            style={{
              background: C.surface2, border: `1.5px solid ${C.border}`,
              color: C.text3, borderRadius: "10px", padding: "0 12px",
      ...
      {error && (
        <div style={{
          ...
          color: C.danger, fontWeight: "600", fontSize: "14px",
          marginBottom: "16px",
        }}>
          ⚠️ {error}
        </div>
            ...
            return (
              ...
              >
                ...
                <div style={{
                  ...
                  <PlaylistPlayIcon style={{ fontSize: 26, color: isAdded ? "#fff" : C.primary }} />
                </div>

                {/* Info */}
                <div style={{ flex: 1, minWidth: 0 }}>
                  <p style={{
                    margin: "0 0 2px", color: C.text, fontWeight: "700",
                  ...
                  {pl.description && (
                    <p style={{ margin: 0, color: C.text3, fontSize: "12px", fontWeight: "600" }}>
                      {pl.description}
                    </p>
                  )}
